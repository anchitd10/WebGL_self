...
var InitDemo = function () {
	...
	var boxVertices = [
		...
		/// Back Face (ensure normals point outwards)
		-1.0, -1.0, -1.0, 0.0, 1.0, 0.0, // Bottom Left (normal points outwards)
		1.0, -1.0, -1.0, 0.0, 1.0, 0.0, // Bottom Right (normal points outwards)
		1.0, 1.0, -1.0, 0.0, 1.0, 0.0, // Top Right (normal points outwards)
		-1.0, 1.0, -1.0, 0.0, 1.0, 0.0, // Top Left (normal points outwards)
	...
	// Set initial world matrix (identity for no initial rotation/translation)
    mat4.identity(worldMatrix);

    // Set view matrix to position the camera slightly behind the cube
    mat4.lookAt(viewMatrix, [0, 0, 8], [0, 0, 0], [0, 1, 0]); // Look at the cube from behind

    // Set perspective projection matrix (adjust field of view if needed)
    mat4.perspective(projMatrix, glMatrix.toRadian(45), canvas.clientWidth / canvas.clientHeight, 0.1, 1000.0);

	// Set the world, view, and projection matrices in the shader
